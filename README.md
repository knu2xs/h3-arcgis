...
Marrying the worlds of the Uber H3 library and ArcGIS.
...
```
    ...
    ├── setup.py           <- Setup script for the library (h3_py)
    ...
    │   ├── h3-py.aprx <- ArcGIS Pro project.    
    │   └── h3-py.tbx  <- ArcGIS Pro toolbox associated with the project.
    ...
    └── src                <- Source code for use in this project.
        └── h3_py <- Library containing the bulk of code used in this 
                                                  project. 
```
